  ...
  <div className='row text-center '>
    <div className='col-sm-4'>
      <div className='thumbnail'>
        <img src='unidade.png' alt='Foto da unidade do Riacho Fundo I' width='400' height='300'/>
    ...
    <div className='col-sm-4'>
      <div className='thumbnail'>
        <img src='unidade.png' alt='Foto da unidade de Águas Claras' width='400' height='300'/>
    ...
    <div className='col-sm-4'>
      <div className='thumbnail'>
        <img src='unidade.png' alt='Foto da unidade de Taguatinga Sul' width='400' height='300'/>
